...
// ii) === 
// The === operator is used for strict equality comparison. It compares both the values and the data types of the operands, without performing type coercion.// console.log(5 === "5"); // false because the number 5 and the string "5" are different data types