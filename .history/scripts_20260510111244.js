...
// 22.Differentiate between variables and data types with examples. 

// A variable is a container used to store data.
// let name = "Alice";
// Data types are the types of data that a variable can hold, such as numbers, strings, booleans, etc.
// let age = 25; // number
...
// 23.What is a data type? (2 Marks) 
// A data type is a classification of data that tells the computer how to interpret and manipulate the data. It defines the kind of value a variable can hold, such as numbers, strings, booleans, etc. Data types help ensure that operations performed on the data are appropriate for its type.



// no 24
// 24.Differentiate between JavaScript variables and operators, with examples

// JavaScript variables are used to store data values. They can hold different types of data, such as numbers, strings, booleans, etc.
let name = "Bob"; // variable storing a string value

// JavaScript operators are symbols that perform operations on variables and values. They can be arithmetic, comparison, logical, etc.
let x = 10;
let y = 5;
console.log(x + y); // using the + operator to add two variables, output is 15

// no 26

// 26.Which of these is a valid variable name? 
// i) 2name 
// ii) myName is a valid variable name because it starts with a letter and does not contain any spaces or special characters.
// iii) let 
// iv) let user-name = "John"; 
// v) let userName = "John"; is a valid variable name because it starts with a letter and uses camelCase notation without any spaces or special characters.
...
// no 29
// 29. Identify and correct the error: 
// i) let age = 20 
// console.log (age 
// The error in this code is that the console.log statement is missing a closing parenthesis. The corrected code should be:
let age = 20;
console.log(age);
...
// ii) let city Kampala; 
// console.log(city); 
// The error in this code is that the variable declaration is missing an assignment operator (=) to assign a value to the variable. The corrected code should be:
let city = "Kampala";
console.log(city);
...
// iii) var score = 90; 
// console.log Score; 
// The error in this code is that the variable name is case-sensitive and should be written as "score" instead of "Score". The corrected code should be:
var score = 90;
console.log(score);

// iv) cosole.log("Welcome"); 
// The error in this code is a typo in the console.log function. The corrected code should be:
console.log("Welcome");
// v) const name = "John"; name = "Peter";
// The error in this code is that a constant variable cannot be reassigned a new value. The corrected code should be:
const name = "John";
// name = "Peter"; // This line should be removed or commented out to avoid the error
