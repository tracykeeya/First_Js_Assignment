...
// i) == 
// The == operator is used for loose equality comparison. It compares the values of the operands and performs type coercion if necessary, meaning it converts the operands to a common type before making the comparison. For example:
// ii) === 
